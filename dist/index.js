...
try {
    const operation = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('operation')
    const filePath = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('filePath')

    switch (operation) {
        case 'set':
            ;(0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.info)('using "set" operation')
            ...
            const newData = { image: dockerImage}
        ...
        case 'get':
            ...
            ;(0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput)('result', data);
            break
        default:
            ;(0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.error)('Operation invalid. Use either "get" or "set" as the operation parameter')
            ;(0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.setFailed)('invalid operation')
    }
